...
const AdminPanel = () => {
  ...
  const registeredBuyers = registeredUsers.filter(
    (user) => user.role === "buyer",
  );
  const registeredSellers = registeredUsers.filter(
  ...
  const approveProperty = (id) => {
    ...
    dispatch(
      showToast({ message: `Property ID ${id} Approved!`, type: "success" }),
    );
  };
  ...
  const rejectProperty = (id) => {
    ...
    dispatch(
      showToast({ message: `Property ID ${id} Rejected`, type: "error" }),
    );
  };
                ...
                <td className="p-4 text-center space-x-3">
                  {!property.approved && (
                    <button
                      ...
                      className="bg-green-600 text-white px-5 py-2 rounded-xl text-sm hover:cursor-pointer"
                    >
                      Approve
                    </button>
                  )}
                  <button
                    ...
                    className="bg-red-600 text-white px-5 py-2 rounded-xl text-sm hover:cursor-pointer"
                  >
                    Reject
                  </button>
                </td>
